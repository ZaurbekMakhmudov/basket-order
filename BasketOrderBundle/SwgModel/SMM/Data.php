...
class Data
{
     ...
     * @SWG\Property(type="array", property="shipments", description="Данные об отправлениях", @SWG\Items(ref=@Model(type=App\BasketOrderBundle\SwgModel\SMM\Shipments::class)))
     */
    public $shipments;
