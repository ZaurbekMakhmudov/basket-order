...
class Basket
{
    ...
    private $coupons;
    /**
     * @SWG\Property(type="string", example="2775076098159", description="номер карты")
     */
    private $cardNum;
    /**
     * @SWG\Property(property="card", type="object", description="данные по картте из вирт кассы", ref=@Model(type=App\BasketOrderBundle\SwgModel\Card::class))
     */
    private $card;
    /**
